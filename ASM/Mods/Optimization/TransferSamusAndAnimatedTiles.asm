...
if !InstantPickups_Oi27 == 0
	org $82895A : LDA #$8000 : TRB $071F : TRB $0721 ; Clear Samus tiles transfer flags	;commented due to conflict with instapick + reduced majors. integrated into that patch
endif
