...
BeamGlowDurationNormalShot:
	...
	LDA.w #!BeamGlowFixedBitNormal*$40+!BeamGlowFixedTransitionNormal*$100+!BeamGlowDurationNormal+$8000 : STA $0B18
+ : RTL
