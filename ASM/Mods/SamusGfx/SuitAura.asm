...
{
PHX : PHY
LDA $0CD0 : CMP #$0078 : BNE +
LDA $09A6 : BIT #$0002 : BNE ++
+
LDA $09A2 : BIT #!AuraITM : BEQ ..out	;if Gravity Suit not Equipped, abort
LDA $0AD2 : CMP #$0001 : BNE ..out		;if physics is not water, abort
...
PHA
	LDA !AuraRAM : BPL +
		;LDA $09A6 : BIT #$0002 : BEQ +++	;uncomment to check for ice only

;		LDA $0A6A : BNE ++	;check for critical health

		LDA $0CD0 : CMP #$0078 : BEQ ++	;checking for full charge
			+++
			print pc
