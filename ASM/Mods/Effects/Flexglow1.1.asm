...
!timer = $173A,x			;relative specific glow timer Enemy 1F RAM (32nd enemy in the room)
!timer2 = $174A,x			;relative specific timer used for intensity

org $A0868F : JSR FlexGlowHijack ;main hijack point, also used by DSO's glowpatch, so REPOINT THIS incase you're using it
org !freeA0 				; push stuff in case it's needed later
FlexGlowHijack:
	PHA : PHX : PHY : PHB
	JSL MAINGLOW
	PLB : PLY : PLX : PLA
...
print "FLEXGLOW: ", pc
;!UseGlobalDefaults = 0
;if !UseGlobalDefaults == 0
	LDA $0A78 : BNE GETOUT								;pause time
;else
;	;branching to getout is too far away if loading a default value. so RTL manually.
;	LDA $0A78 : BEQ +								;pause time
;	RTL
;	+
;endif 
	PEA !bank : PLB : PLB
...
;if !UseGlobalDefaults == 0
	BEQ GETOUT 					;loads roomVAR value for the current roomstate
	BPL GETOUT
;else
;	BMI +
;	LDA.w #DEFAULT_START-1
;	+
;endif
...
greenBACK:
	...
	JMP BLUESUB
SUBBLUEBACK:
	INX : INX : CPX $16 : BMI back_flexglow						;Increase until max. palette bit
	LDX $1A : INC !timer2
	LDA $0006,y : AND #$00FF : CMP !timer2 : BNE +		;intensity
	STZ !timer2
...
;-----------------
; 	DB $04, $02 : DW $0099 : DB $04, $07, $08		;Cycle line 1 9-C

; 	DB $04, $02 : DW $009D : DB $03, $07, $08		;Cycle line 1 D-F

; 	DB $04, $00 : DW $0099 : DB $04, $01, $04		;Glow line 1 9-C Red
; 	DB $04, $00 : DW $0099 : DB $04, $02, $04		;Glow line 1 9-C Green
; 	DB $04, $00 : DW $0099 : DB $04, $03, $04		;Glow line 1 9-C Yellow
; 	DB $04, $00 : DW $0099 : DB $04, $04, $04		;Glow line 1 9-C Blue
; 	DB $04, $00 : DW $0099 : DB $04, $05, $04		;Glow line 1 9-C Magenta
; 	DB $04, $00 : DW $0099 : DB $04, $06, $04		;Glow line 1 9-C Cyan
; 	DB $04, $00 : DW $0099 : DB $04, $07, $04		;Glow line 1 9-C White

; 	DB $04, $00 : DW $009D : DB $03, $01, $04		;Glow line 1 D-F Red
; 	DB $04, $00 : DW $009D : DB $03, $02, $04		;Glow line 1 D-F Green
; 	DB $04, $00 : DW $009D : DB $03, $03, $04		;Glow line 1 D-F Yellow
; 	DB $04, $00 : DW $009D : DB $03, $04, $04		;Glow line 1 D-F Blue
; 	DB $04, $00 : DW $009D : DB $03, $05, $04		;Glow line 1 D-F Magenta
; 	DB $04, $00 : DW $009D : DB $03, $06, $04		;Glow line 1 D-F Cyan
; 	DB $04, $00 : DW $009D : DB $03, $07, $04		;Glow line 1 D-F White

;Metaree
; 	DB $04, $00 : DW $0091 : DB $03, $02, $04		;Glow line 1 1-4 Green
; 	DB $04, $02 : DW $0099 : DB $04, $07, $08		;Cycle line 1 9-D

;Metroid
; 	DB $04, $00 : DW $0091 : DB $03, $02, $04		;Glow line 1 1-4 Green
; 	DB $04, $02 : DW $0095 : DB $05, $07, $08		;Cycle line 1 5-9
; 	DB $04, $02 : DW $009A : DB $03, $07, $08		;Cycle line 1 A-C

;Misc
; 	DB $02, $00 : DW $0028 : DB $03, $07, $08		;grey door	
; 	DB $02, $00 : DW $0031 : DB $03, $07, $08		;blue door
; 	DB $02, $00 : DW $0011 : DB $03, $07, $08		;green door
; 	DB $02, $00 : DW $0001 : DB $03, $07, $08		;yellow door
; 	DB $02, $00 : DW $0021 : DB $03, $07, $08		;red door
; 	DB $06, $00 : DW $00C3 : DB $01, $04, $12		;samus outline
;	DB $01, $00 : DW $00C4 : DB $01, $07, $08		;samus visor
;	DB $01, $00 : DW $00C7 : DB $02, $07, $02		;samus canon (lightest colors)
;	DB $01, $01 : DW $00E1 : DB $08, $07, $04		;beams

;FX palette
;	DB $06, $00 : DW $0018 : DB $04, $07, $12 

	;Geemer
;	DB $20, $03 : DW $0099 : DB $03, $07, $08		;Cycle line 1 9-B
;	DB $04, $01 : DW $009D : DB $02, $02, $08		;Deglow line 1 D-F Green
	;Ripper
;	DB $03, $00 : DW $00A4 : DB $01, $03, $06		;Glow line 2 4 Yellow								
;	DB $20, $02 : DW $00A2 : DB $07, $07, $08		;Cycle line 2 2-8
	;Rio
;	DB $01, $00 : DW $009D : DB $03, $01, $18		;Glow line 1 D-F Red
	;Waver
;	DB $01, $01 : DW $0099 : DB $03, $01, $10		;Deglow line 1 9-C Red
;	DB $01, $00 : DW $0094 : DB $01, $05, $10		;Glow line 1 9-C Magenta
	;Sidehopper
;	DB $01, $00 : DW $0094 : DB $01, $02, $08		;Glow line 1 4 Green
;	DB $02, $00 : DW $009E : DB $02, $02, $10		;Deglow line 1 9-C Green
	;Skree
;	DB $08, $02 : DW $00BA : DB $03, $02, $08		;Cycle line 3 A-C
;	DB $03, $00 : DW $00BE : DB $02, $05, $08		;Glow line 3 E-F Magenta
;--------------------

;================================ Sector 1 Level 0 =================================================
print " Table pointer: ", pc
namespace "DEFAULT"			;ASAR adds the underscore automagically.
;namespace "DEFAULT_"		;XKAS needs an underscore in the namespace.
DB (END-START)/7
START:
 	DB $02, $00 : DW $0031 : DB $03, $07, $08		;blue door
 	DB $02, $00 : DW $0011 : DB $03, $07, $08		;green door
 	DB $02, $00 : DW $0001 : DB $03, $07, $08		;yellow door
 	DB $02, $00 : DW $0021 : DB $03, $07, $08		;red door
	DB $01, $01 : DW $00C7 : DB $02, $07, $08		;samus canon (lightest colors)
END:

print " Table pointer: ", pc

namespace "ROOM1_"									;namespace puts additional tags before the lables (prefixes), in this case, it renames START to ROOM1_START
...
;	DB $02, $00 : DW $0031 : DB $03, $07, $08		;example: go down 1 line, then go right 1 palette bit, choose three palette bits from there >> green doorcap palette
...
;uncomment the below for more glows

 print " Table pointer: ", pc
 namespace "ROOM2_"								;rename this every time you copy/paste this section
 	DB (END-START)/7				;again, don't change this line
 START:
...
;uncomment the below for more glows
 ...
 print " Table pointer: ", pc
 namespace "ROOM3_"								;rename this every time you copy/paste this section
 	DB (END-START)/7				;again, don't change this line
 START:
 	DB $02, $00 : DW $0028 : DB $03, $07, $08		;grey door
 	DB $02, $00 : DW $0031 : DB $03, $07, $08		;blue door
...
;uncomment the below for more glows
 ...
 print " Table pointer: ", pc
 namespace "ROOM4_"								;rename this every time you copy/paste this section
 	DB (END-START)/7				;again, don't change this line
 START:
 	DB $02, $00 : DW $0028 : DB $03, $07, $08		;grey door
 	DB $02, $00 : DW $0031 : DB $03, $07, $08		;blue door
...
;uncomment the below for more glows
 ...
 print " Table pointer: ", pc
 namespace "ROOM5_"								;rename this every time you copy/paste this section
 	DB (END-START)/7				;again, don't change this line
 START:
 	DB $02, $00 : DW $0028 : DB $03, $07, $08		;grey door
 	DB $02, $00 : DW $0031 : DB $03, $07, $08		;blue door
