...
CollisionRoutineTable:				;projectile collision detection
	...
	DW GotoMoveProjectileVertical, GotoMoveProjectileDiagonal, GotoMoveProjectileHorizontal, GotoMoveProjectileDiagonal, GotoMoveProjectileVertical
GotoMoveProjectileVertical: JSL MoveProjectileVertical : RTS
GotoMoveProjectileDiagonal: JSL MoveProjectileDiagonal : RTS
GotoMoveProjectileHorizontal: JSL MoveProjectileHorizontal : RTS
...
ORG Compatability
print "beampatch label"
print pc
LDA.l ChargeShineSpriteOffsetLeft,x	;charge shine offset index (left)
...
+++ : JSL $818A4B : PLB : RTL	;draw projectile sprites and return
;3 bytes left
