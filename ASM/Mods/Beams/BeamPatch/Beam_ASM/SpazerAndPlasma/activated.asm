...
PRINT "Spazer+Plasma:   activated" : PRINT ""

;--------------------------------------- Bank $82 --------------------------------------------------
ORG $82AFD6 : BRA $01 : NOP			;disable spazer and plasma weapon check

;--------------------------------------- Bank $84 --------------------------------------------------
;ORG $8488C5 : BRA $FF				;skip unequipping spazer/plasma during item pickup
ORG $8488C5 : BRA SkipSpazerPlasmaToggle

org $8488D6
SkipSpazerPlasmaToggle:

{;-------------------------------------- Bank $90 --------------------------------------------------
ORG $90AC96 : AND #$0F1F          	;change filter from update beam tiles and palettes
ORG $90ACA5 : LDA.w BeamTilesPointer,y
ORG $90ACC8 : AND #$0F0F         	;change filter from write beam palette
...
if !UniversalAmmo_Tundain == 0
	ORG $90CCD6 : SBC.w SBACost,x
	ORG $90CCE1 : JSR (SBAInstructionPoiner,x)
endif

;Various projectile data
ORG $90C260 : DB $0F, $0F, $0F, $0F	;uncharged beam cooldown
ORG $90C270 : DB $1E, $1E, $1E, $1E	;charged beam cooldown
ORG $90C28F : DB $19, $19, $19, $19 ;beam auto-fire cooldown
...
SBAInstructionPoiner:
	DW $CD18, $CD1A, $CD9B, $CD18
	DW $CE14, $CD18, $CD18, $CD18
	DW $CE98, $CD18, $CD18, $CD18
	DW $CD18, $CD18, $CD18, $CD18
}

{;-------------------------------------- Bank $93 --------------------------------------------------
ORG $938021 : LDA NormalBeamsListPointer,y
ORG $93802C : LDA ChargedBeamsListPointer,y
...
ORG !free93
print "beampatch freespace starts: ", pc
;org $9386DB

; Spazer and Plasma combo addition
NormalBeamsListPointer:
	DW $8431, $84B5, $849F, $84E1
	DW $8447, $84F7, $845D, $8473
	DW $84CB, $850D, $8523, $8489
	DW Beam_Normal_SpazerPlasma, Beam_Normal_SpazerPlasmaWave, Beam_Normal_SpazerPlasmaIce, Beam_Normal_SpazerPlasmaWaveIce

ChargedBeamsListPointer:
	DW $8539, $85D3, $85A7, $85E9
	DW $854F, $85FF, $8565, $857B
	DW $85BD, $862B, $8615, $8591
	DW Beam_Charged_SpazerPlasma, Beam_Charged_SpazerPlasmaWave, Beam_Charged_SpazerPlasmaIce, Beam_Charged_SpazerPlasmaWaveIce


Beam_Normal_SpazerPlasma: DW !Damage_Normal_SP, Normal_SpazerPlasma_Up, Normal_SpazerPlasma_UpRight, Normal_SpazerPlasma_Right, Normal_SpazerPlasma_DownRight, Normal_SpazerPlasma_Down, Normal_SpazerPlasma_Down, Normal_SpazerPlasma_DownLeft, Normal_SpazerPlasma_Left, Normal_SpazerPlasma_UpLeft, Normal_SpazerPlasma_Up
Beam_Normal_SpazerPlasmaIce: DW !Damage_Normal_SPI, Normal_SpazerPlasma_Up, Normal_SpazerPlasma_UpRight, Normal_SpazerPlasma_Right, Normal_SpazerPlasma_DownRight, Normal_SpazerPlasma_Down, Normal_SpazerPlasma_Down, Normal_SpazerPlasma_DownLeft, Normal_SpazerPlasma_Left, Normal_SpazerPlasma_UpLeft, Normal_SpazerPlasma_Up
Beam_Normal_SpazerPlasmaWave: DW !Damage_Normal_SPW, Normal_SpazerPlasmaWave_Up, Normal_SpazerPlasmaWave_UpRight, Normal_SpazerPlasmaWave_Right, Normal_SpazerPlasmaWave_DownRight, Normal_SpazerPlasmaWave_Down, Normal_SpazerPlasmaWave_Down, Normal_SpazerPlasmaWave_DownLeft, Normal_SpazerPlasmaWave_Left, Normal_SpazerPlasmaWave_UpLeft, Normal_SpazerPlasmaWave_Up
Beam_Normal_SpazerPlasmaWaveIce: DW !Damage_Normal_SPWI, Normal_SpazerPlasmaWave_Up, Normal_SpazerPlasmaWave_UpRight, Normal_SpazerPlasmaWave_Right, Normal_SpazerPlasmaWave_DownRight, Normal_SpazerPlasmaWave_Down, Normal_SpazerPlasmaWave_Down, Normal_SpazerPlasmaWave_DownLeft, Normal_SpazerPlasmaWave_Left, Normal_SpazerPlasmaWave_UpLeft, Normal_SpazerPlasmaWave_Up

Beam_Charged_SpazerPlasma: DW !Damage_Charged_SP, Charged_SpazerPlasma_Up, Charged_SpazerPlasma_UpRight, Charged_SpazerPlasma_Right, Charged_SpazerPlasma_DownRight, Charged_SpazerPlasma_Down, Charged_SpazerPlasma_Down, Charged_SpazerPlasma_DownLeft, Charged_SpazerPlasma_Left, Charged_SpazerPlasma_UpLeft, Charged_SpazerPlasma_Up
Beam_Charged_SpazerPlasmaIce: DW !Damage_Charged_SPI, Charged_SpazerPlasma_Up, Charged_SpazerPlasma_UpRight, Charged_SpazerPlasma_Right, Charged_SpazerPlasma_DownRight, Charged_SpazerPlasma_Down, Charged_SpazerPlasma_Down, Charged_SpazerPlasma_DownLeft, Charged_SpazerPlasma_Left, Charged_SpazerPlasma_UpLeft, Charged_SpazerPlasma_Up
Beam_Charged_SpazerPlasmaWave: DW !Damage_Charged_SPW, Charged_SpazerPlasmaWave_Up, Charged_SpazerPlasmaWave_UpRight, Charged_SpazerPlasmaWave_Right, Charged_SpazerPlasmaWave_DownRight, Charged_SpazerPlasmaWave_Down, Charged_SpazerPlasmaWave_Down, Charged_SpazerPlasmaWave_DownLeft, Charged_SpazerPlasmaWave_Left, Charged_SpazerPlasmaWave_UpLeft, Charged_SpazerPlasmaWave_Up
Beam_Charged_SpazerPlasmaWaveIce: DW !Damage_Charged_SPWI, Charged_SpazerPlasmaWave_Up, Charged_SpazerPlasmaWave_UpRight, Charged_SpazerPlasmaWave_Right, Charged_SpazerPlasmaWave_DownRight, Charged_SpazerPlasmaWave_Down, Charged_SpazerPlasmaWave_Down, Charged_SpazerPlasmaWave_DownLeft, Charged_SpazerPlasmaWave_Left, Charged_SpazerPlasmaWave_UpLeft, Charged_SpazerPlasmaWave_Up
...
INCSRC Beam_ASM/ProjectileInstruction/!BeamTypePlasma/!BeamPattern/normal-SpazerPlasma.asm
...
INCSRC Beam_ASM/ProjectileInstruction/!BeamTypePlasma/!BeamPattern/charged-SpazerPlasma.asm
...
;PRINT "Start of freespace in bank $93: $", PC : PRINT ""

print "beampatch freespace ends: ", pc
!free93 #= pc()
