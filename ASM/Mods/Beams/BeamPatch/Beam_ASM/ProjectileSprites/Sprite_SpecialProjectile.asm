...
Sprite_BombExplosion_1: DW $0004
	DW $0000 : DB $00 : DW $FA8B
	DW $01F8 : DB $00 : DW $BA8B
	DW $0000 : DB $F8 : DW $7A8B
	DW $01F8 : DB $F8 : DW $3A8B
Sprite_BombExplosion_2: DW $0004
	DW $0000 : DB $00 : DW $FA7A
	DW $01F8 : DB $00 : DW $BA7A
	DW $0000 : DB $F8 : DW $7A7A
	DW $01F8 : DB $F8 : DW $3A7A
Sprite_BombExplosion_3: DW $0004
	DW $C200 : DB $00 : DW $FA70
	DW $C3F0 : DB $00 : DW $BA70
	DW $C200 : DB $F0 : DW $7A70
	DW $C3F0 : DB $F0 : DW $3A70
Sprite_BombExplosion_4: DW $0004
	DW $C200 : DB $00 : DW $FA72
	DW $C3F0 : DB $00 : DW $BA72
	DW $C200 : DB $F0 : DW $7A72
	DW $C3F0 : DB $F0 : DW $3A72
Sprite_BombExplosion_5: DW $0004
	DW $C200 : DB $00 : DW $FA74
	DW $C3F0 : DB $00 : DW $BA74
	DW $C200 : DB $F0 : DW $7A74
	DW $C3F0 : DB $F0 : DW $3A74
...
Sprite_ChargeShine_1: DW $0001
	DW $01FC : DB $FC : DW $2C3F
if !MiscSpritesFreeUp_Tundain == 1
bigger:
endif
Sprite_ChargeShine_2: DW $0001
	DW $01FC : DB $FC : DW $2C3E
if !MiscSpritesFreeUp_Tundain == 1
mediumsized:
endif
Sprite_ChargeShine_3: DW $0001
	DW $01FC : DB $FC : DW $2C3D
if !MiscSpritesFreeUp_Tundain == 1
largest:
endif
Sprite_ChargeShine_4: DW $0004
	DW $01F8 : DB $00 : DW $AC3C
	DW $0000 : DB $00 : DW $EC3C
	DW $0000 : DB $F8 : DW $6C3C
	DW $01F8 : DB $F8 : DW $2C3C
