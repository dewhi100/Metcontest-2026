...
Charged_SpazerWave_UpRight_Loop:
	...
	DW $0001, SL_C_SW_UpRight_1C : DB $12, $12
	DW $0001, SL_C_SW_UpRight_2N : DB $13, $13
	DW $0001, SL_C_SW_UpRight_2C : DB $13, $13
	DW $0001, SL_C_S_UpRight_N : DB $14, $14
	DW $0001, SL_C_S_UpRight_C : DB $14, $14
	DW $0001, SL_C_S_UpRight_N : DB $14, $14
	DW $0001, SL_C_SW_UpRight_2C : DB $13, $13
...
Charged_SpazerWave_DownRight_Loop:
	...
	DW $0001, SL_C_SW_DownRight_1C : DB $12, $12
	DW $0001, SL_C_SW_DownRight_2N : DB $13, $13
	DW $0001, SL_C_SW_DownRight_2C : DB $13, $13
	DW $0001, SL_C_S_DownRight_N : DB $14, $14
	DW $0001, SL_C_S_DownRight_C : DB $14, $14
	DW $0001, SL_C_S_DownRight_N : DB $14, $14
	DW $0001, SL_C_SW_DownRight_2C : DB $13, $13
...
Charged_SpazerWave_DownLeft_Loop:
	...
	DW $0001, SL_C_SW_DownLeft_1C : DB $12, $12
	DW $0001, SL_C_SW_DownLeft_2N : DB $13, $13
	DW $0001, SL_C_SW_DownLeft_2C : DB $13, $13
	DW $0001, SL_C_S_DownLeft_N : DB $14, $14
	DW $0001, SL_C_S_DownLeft_C : DB $14, $14
	DW $0001, SL_C_S_DownLeft_N : DB $14, $14
	DW $0001, SL_C_SW_DownLeft_2C : DB $13, $13
...
Charged_SpazerWave_UpLeft_Loop:
	...
	DW $0001, SL_C_SW_UpLeft_1C : DB $12, $12
	DW $0001, SL_C_SW_UpLeft_2N : DB $13, $13
	DW $0001, SL_C_SW_UpLeft_2C : DB $13, $13
	DW $0001, SL_C_S_UpLeft_N : DB $14, $14
	DW $0001, SL_C_S_UpLeft_C : DB $14, $14
	DW $0001, SL_C_S_UpLeft_N : DB $14, $14
	DW $0001, SL_C_SW_UpLeft_2C : DB $13, $13
...
SL_C_SW_Up_1N:
	DW S_N_S_Up : DB $00, $00
	DW S_N_S_Up : DB $F5, $00
	DW S_N_S_Up : DB $0B, $00
	DW $0000
SL_C_SW_Up_1C:
	DW S_C_S_Up : DB $00, $00
...
SL_C_SW_UpRight_2N:
	DW S_N_S_UpRight : DB $00, $00
	DW S_N_S_UpRight : DB $F6, $F6
	DW S_N_S_UpRight : DB $0A, $0A
	DW $0000
SL_C_SW_UpRight_2C:
	DW S_C_S_UpRight : DB $00, $00
...
SL_C_SW_DownRight_2N:
	DW S_N_S_DownRight : DB $00, $00
	DW S_N_S_DownRight : DB $0A, $F6
	DW S_N_S_DownRight : DB $F6, $0A
	DW $0000
...
SL_C_SW_DownLeft_2N:
	DW S_N_S_DownLeft : DB $00, $00
	DW S_N_S_DownLeft : DB $F6, $F6
	DW S_N_S_DownLeft : DB $0A, $0A
	DW $0000
SL_C_SW_DownLeft_2C:
	DW S_C_S_DownLeft : DB $00, $00
...
SL_C_SW_UpLeft_1N:
	DW S_N_S_UpLeft : DB $00, $00
	DW S_N_S_UpLeft : DB $08, $F8
	DW S_N_S_UpLeft : DB $F8, $08
	DW $0000
SL_C_SW_UpLeft_1C:
	DW S_C_S_UpLeft : DB $00, $00
...
SL_C_SW_UpLeft_2N:
	DW S_N_S_UpLeft : DB $00, $00
	DW S_N_S_UpLeft : DB $0A, $F6
	DW S_N_S_UpLeft : DB $F6, $0A
	DW $0000
SL_C_SW_UpLeft_2C:
	DW S_C_S_UpLeft : DB $00, $00
