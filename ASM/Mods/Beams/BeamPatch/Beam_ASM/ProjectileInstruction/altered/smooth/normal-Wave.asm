...
Normal_Wave_Up_Loop:
	...
	DW $0001, SL_N_W_Up_Left_2 : DB $10, $04
	DW $0001, SL_N_W_Up_Left_3B : DB $12, $04
	DW $0001, SL_N_W_Up_Left_4 : DB $14, $04
	DW $0001, SL_N_W_Up_Left_3A : DB $12, $04
	DW $0001, SL_N_W_Up_Left_2 : DB $10, $04
	DW $0001, SL_N_W_Up_Left_1B : DB $0C, $04
Normal_Wave_Up_Branch:
	DW $0001, S_N_W_Up_1 : DB $0C, $04
	DW $0001, SL_N_W_Up_Right_1A : DB $0C, $04
	DW $0001, SL_N_W_Up_Right_2 : DB $10, $04
	DW $0001, SL_N_W_Up_Right_3B : DB $12, $04
	DW $0001, SL_N_W_Up_Right_4 : DB $14, $04
	DW $0001, SL_N_W_Up_Right_3A : DB $12, $04
	DW $0001, SL_N_W_Up_Right_2 : DB $10, $04
...
Normal_Wave_UpRight_Loop:
	...
	DW $0001, SL_N_W_UpRight_UpLeft_1A : DB $08, $08
	DW $0001, SL_N_W_UpRight_UpLeft_2 : DB $0A, $0A
	DW $0001, SL_N_W_UpRight_UpLeft_3B : DB $0C, $0C
	DW $0001, SL_N_W_UpRight_UpLeft_4 : DB $0C, $0C
	DW $0001, SL_N_W_UpRight_UpLeft_3A : DB $0C, $0C
	DW $0001, SL_N_W_UpRight_UpLeft_2 : DB $0A, $0A
	DW $0001, SL_N_W_UpRight_UpLeft_1B : DB $08, $08
	DW $0001, S_N_W_UpRight_1 : DB $04, $04
	DW $0001, SL_N_W_UpRight_DownRight_1A : DB $08, $08
	DW $0001, SL_N_W_UpRight_DownRight_2 : DB $0A, $0A
	DW $0001, SL_N_W_UpRight_DownRight_3B : DB $0C, $0C
	DW $0001, SL_N_W_UpRight_DownRight_4 : DB $0C, $0C
	DW $0001, SL_N_W_UpRight_DownRight_3A : DB $0C, $0C
	DW $0001, SL_N_W_UpRight_DownRight_2 : DB $0A, $0A
	DW $0001, SL_N_W_UpRight_DownRight_1B : DB $08, $08
...
Normal_Wave_Right_Loop:
	...
	DW $0001, SL_N_W_Right_Up_2 : DB $04, $10
	DW $0001, SL_N_W_Right_Up_3B : DB $04, $12
	DW $0001, SL_N_W_Right_Up_4 : DB $04, $14
	DW $0001, SL_N_W_Right_Up_3A : DB $04, $12
	DW $0001, SL_N_W_Right_Up_2 : DB $04, $10
	DW $0001, SL_N_W_Right_Up_1B : DB $04, $0C
	DW $0001, S_N_W_Right_1 : DB $04, $0C
	DW $0001, SL_N_W_Right_Down_1A : DB $04, $0C
	DW $0001, SL_N_W_Right_Down_2 : DB $04, $10
	DW $0001, SL_N_W_Right_Down_3B : DB $04, $12
	DW $0001, SL_N_W_Right_Down_4 : DB $04, $14
	DW $0001, SL_N_W_Right_Down_3A : DB $04, $12
	DW $0001, SL_N_W_Right_Down_2 : DB $04, $10
...
Normal_Wave_DownRight_Loop:
	...
	DW $0001, SL_N_W_DownRight_UpRight_1A : DB $08, $08
	DW $0001, SL_N_W_DownRight_UpRight_2 : DB $0A, $0A
	DW $0001, SL_N_W_DownRight_UpRight_3B : DB $0C, $0C
	DW $0001, SL_N_W_DownRight_UpRight_4 : DB $0C, $0C
	DW $0001, SL_N_W_DownRight_UpRight_3A : DB $0C, $0C
	DW $0001, SL_N_W_DownRight_UpRight_2 : DB $0A, $0A
	DW $0001, SL_N_W_DownRight_UpRight_1B : DB $08, $08
	DW $0001, S_N_W_DownRight_1 : DB $04, $04
	DW $0001, SL_N_W_DownRight_DownLeft_1A : DB $08, $08
	DW $0001, SL_N_W_DownRight_DownLeft_2 : DB $0A, $0A
	DW $0001, SL_N_W_DownRight_DownLeft_3B : DB $0C, $0C
	DW $0001, SL_N_W_DownRight_DownLeft_4 : DB $0C, $0C
	DW $0001, SL_N_W_DownRight_DownLeft_3A : DB $0C, $0C
	DW $0001, SL_N_W_DownRight_DownLeft_2 : DB $0A, $0A
	DW $0001, SL_N_W_DownRight_DownLeft_1B : DB $08, $08
...
Normal_Wave_Down_Loop:
	...
	DW $0001, SL_N_W_Down_Left_2 : DB $10, $04
	DW $0001, SL_N_W_Down_Left_3B : DB $12, $04
	DW $0001, SL_N_W_Down_Left_4 : DB $14, $04
	DW $0001, SL_N_W_Down_Left_3A : DB $12, $04
	DW $0001, SL_N_W_Down_Left_2 : DB $10, $04
	DW $0001, SL_N_W_Down_Left_1B : DB $0C, $04
Normal_Wave_Down_Branch:
	DW $0001, S_N_W_Down_1 : DB $0C, $04
	DW $0001, SL_N_W_Down_Right_1A : DB $0C, $04
	DW $0001, SL_N_W_Down_Right_2 : DB $10, $04
	DW $0001, SL_N_W_Down_Right_3B : DB $12, $04
	DW $0001, SL_N_W_Down_Right_4 : DB $14, $04
	DW $0001, SL_N_W_Down_Right_3A : DB $12, $04
	DW $0001, SL_N_W_Down_Right_2 : DB $10, $04
...
Normal_Wave_DownLeft_Loop:
	...
	DW $0001, SL_N_W_DownLeft_UpLeft_1A : DB $08, $08
	DW $0001, SL_N_W_DownLeft_UpLeft_2 : DB $0A, $0A
	DW $0001, SL_N_W_DownLeft_UpLeft_3B : DB $0C, $0C
	DW $0001, SL_N_W_DownLeft_UpLeft_4 : DB $0C, $0C
	DW $0001, SL_N_W_DownLeft_UpLeft_3A : DB $0C, $0C
	DW $0001, SL_N_W_DownLeft_UpLeft_2 : DB $0A, $0A
	DW $0001, SL_N_W_DownLeft_UpLeft_1B : DB $08, $08
	DW $0001, S_N_W_DownLeft_1 : DB $04, $04
	DW $0001, SL_N_W_DownLeft_DownRight_1A : DB $08, $08
	DW $0001, SL_N_W_DownLeft_DownRight_2 : DB $0A, $0A
	DW $0001, SL_N_W_DownLeft_DownRight_3B : DB $0C, $0C
	DW $0001, SL_N_W_DownLeft_DownRight_4 : DB $0C, $0C
	DW $0001, SL_N_W_DownLeft_DownRight_3A : DB $0C, $0C
	DW $0001, SL_N_W_DownLeft_DownRight_2 : DB $0A, $0A
	DW $0001, SL_N_W_DownLeft_DownRight_1B : DB $08, $08
...
Normal_Wave_Left_Loop:
	...
	DW $0001, SL_N_W_Left_Up_2 : DB $04, $10
	DW $0001, SL_N_W_Left_Up_3B : DB $04, $12
	DW $0001, SL_N_W_Left_Up_4 : DB $04, $14
	DW $0001, SL_N_W_Left_Up_3A : DB $04, $12
	DW $0001, SL_N_W_Left_Up_2 : DB $04, $10
	DW $0001, SL_N_W_Left_Up_1B : DB $04, $0C
	DW $0001, S_N_W_Left_1 : DB $04, $0C
	DW $0001, SL_N_W_Left_Down_1A : DB $04, $0C
	DW $0001, SL_N_W_Left_Down_2 : DB $04, $10
	DW $0001, SL_N_W_Left_Down_3B : DB $04, $12
	DW $0001, SL_N_W_Left_Down_4 : DB $04, $14
	DW $0001, SL_N_W_Left_Down_3A : DB $04, $12
	DW $0001, SL_N_W_Left_Down_2 : DB $04, $10
...
Normal_Wave_UpLeft_Loop:
	...
	DW $0001, SL_N_W_UpLeft_UpRight_1A : DB $08, $08
	DW $0001, SL_N_W_UpLeft_UpRight_2 : DB $0A, $0A
	DW $0001, SL_N_W_UpLeft_UpRight_3B : DB $0C, $0C
	DW $0001, SL_N_W_UpLeft_UpRight_4 : DB $0C, $0C
	DW $0001, SL_N_W_UpLeft_UpRight_3A : DB $0C, $0C
	DW $0001, SL_N_W_UpLeft_UpRight_2 : DB $0A, $0A
	DW $0001, SL_N_W_UpLeft_UpRight_1B : DB $08, $08
	DW $0001, S_N_W_UpLeft_1 : DB $04, $04
	DW $0001, SL_N_W_UpLeft_DownLeft_1A : DB $08, $08
	DW $0001, SL_N_W_UpLeft_DownLeft_2 : DB $0A, $0A
	DW $0001, SL_N_W_UpLeft_DownLeft_3B : DB $0C, $0C
	DW $0001, SL_N_W_UpLeft_DownLeft_4 : DB $0C, $0C
	DW $0001, SL_N_W_UpLeft_DownLeft_3A : DB $0C, $0C
	DW $0001, SL_N_W_UpLeft_DownLeft_2 : DB $0A, $0A
	DW $0001, SL_N_W_UpLeft_DownLeft_1B : DB $08, $08
