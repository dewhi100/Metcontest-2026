...
Normal_SpazerPlasma_DiagonalRight_Loop:
	DW $0002, SL_N_SP_DiagonalRight_A : DB $14, $14
...
Normal_SpazerPlasma_DiagonalLeft_Loop:
	DW $0002, SL_N_SP_DiagonalLeft_A : DB $14, $14
...
Normal_SpazerPlasmaWave_Vertical_Loop:
	...
	DW $0002, SL_N_SPW_Vertical_2B : DB $0C, $10
	DW $0002, SL_N_SPW_Vertical_B : DB $0D, $10
...
Normal_SpazerPlasmaWave_DiagonalRight_Loop:
	...
	DW $0002, SL_N_SPW_DiagonalRight_2B : DB $10, $10
	DW $0002, SL_N_SPW_DiagonalRight_B : DB $11, $11
...
Normal_SpazerPlasmaWave_Horizontal_Loop:
	...
	DW $0002, SL_N_SPW_Horizontal_2B : DB $10, $0C
	DW $0002, SL_N_SPW_Horizontal_B : DB $10, $0D
...
Normal_SpazerPlasmaWave_DiagonalLeft_Loop:
	...
	DW $0002, SL_N_SPW_DiagonalLeft_2B : DB $10, $10
	DW $0002, SL_N_SPW_DiagonalLeft_B : DB $11, $11
...
SL_N_SP_Vertical_3:
	DW S_N_P_Vertical_B : DB $00, $00
	DW S_N_P_Vertical_B : DB $F4, $00
	DW S_N_P_Vertical_B : DB $0C, $00
	DW $0000
SL_N_SP_Vertical_A:
	DW S_N_P_Vertical_A : DB $00, $00
...
SL_N_SP_DiagonalRight_1:
	...
	DW S_N_P_DiagonalRight_B : DB $04, $04
	DW $0000
...
SL_N_SP_Horizontal_3:
	DW S_N_P_Horizontal_B : DB $00, $00
	DW S_N_P_Horizontal_B : DB $00, $F4
	DW S_N_P_Horizontal_B : DB $00, $0C
	DW $0000
...
SL_N_SPW_Vertical_B:
	DW S_N_P_Vertical_A : DB $00, $00
	DW S_N_P_Vertical_A : DB $F7, $00
	DW S_N_P_Vertical_A : DB $09, $00
	DW $0000
SL_N_SPW_Vertical_2B:
	DW S_N_P_Vertical_B : DB $00, $00
...
SL_N_SPW_DiagonalRight_B:
	DW S_N_P_DiagonalRight_A : DB $00, $00
	DW S_N_P_DiagonalRight_A : DB $F9, $F9
	DW S_N_P_DiagonalRight_A : DB $07, $07
	DW $0000
SL_N_SPW_DiagonalRight_2B:
	DW S_N_P_DiagonalRight_B : DB $00, $00
...
SL_N_SPW_Horizontal_B:
	DW S_N_P_Horizontal_A : DB $00, $00
	DW S_N_P_Horizontal_A : DB $00, $F7
	DW S_N_P_Horizontal_A : DB $00, $09
	DW $0000
SL_N_SPW_Horizontal_2B:
	DW S_N_P_Horizontal_B : DB $00, $00
...
SL_N_SPW_DiagonalLeft_B:
	DW S_N_P_DiagonalLeft_A : DB $00, $00
	DW S_N_P_DiagonalLeft_A : DB $07, $F9
	DW S_N_P_DiagonalLeft_A : DB $F9, $07
	DW $0000
SL_N_SPW_DiagonalLeft_2B:
	DW S_N_P_DiagonalLeft_B : DB $00, $00
