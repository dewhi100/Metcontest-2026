...
Charged_SpazerPlasma_Down:
	...
	DW $0001, SL_C_SP_Vertical_1NB : DB $10, $18
	DW $0001, SL_C_SP_Vertical_1CB : DB $10, $18
...
Charged_SpazerPlasma_DownLeft:
	...
	DW $0001, SL_C_SP_DiagonalRight_1NB : DB $10, $10
	DW $0001, SL_C_SP_DiagonalRight_1CB : DB $10, $10
...
Charged_SpazerPlasma_Left:
	...
	DW $0001, SL_C_SP_Horizontal_1NB : DB $18, $10
	DW $0001, SL_C_SP_Horizontal_1CB : DB $18, $10
...
Charged_SpazerPlasma_UpLeft:
	...
	DW $0001, SL_C_SP_DiagonalLeft_1NB : DB $10, $10
	DW $0001, SL_C_SP_DiagonalLeft_1CB : DB $10, $10
...
Charged_SpazerPlasmaWave_Vertical_Loop:
	DW $0001, S_C_P_Vertical_NA : DB $0C, $18
	DW $0001, S_C_P_Vertical_CA : DB $0C, $18
	DW $0001, SL_C_SPW_Vertical_0N : DB $0C, $18
	DW $0001, SL_C_SPW_Vertical_0C : DB $0C, $18
	DW $0001, SL_C_SP_Vertical_1NA : DB $10, $18
	DW $0001, SL_C_SP_Vertical_1CA : DB $10, $18
	DW $0001, SL_C_SPW_Vertical_1N : DB $12, $18
	DW $0001, SL_C_SPW_Vertical_1C : DB $12, $18
	DW $0001, SL_C_SPW_Vertical_2N : DB $14, $18
	DW $0001, SL_C_SPW_Vertical_2C : DB $14, $18
	DW $0001, SL_C_SP_Vertical_NB : DB $14, $18
	DW $0001, SL_C_SP_Vertical_CB : DB $14, $18
	DW $0001, SL_C_SPW_Vertical_2N : DB $14, $18
	DW $0001, SL_C_SPW_Vertical_2C : DB $14, $18
...
Charged_SpazerPlasmaWave_DiagonalRight_Loop:
	DW $0001, S_C_P_DiagonalRight_NA : DB $0C, $0C
	DW $0001, S_C_P_DiagonalRight_CA : DB $0C, $0C
	DW $0001, SL_C_SPW_DiagonalRight_0N : DB $0C, $0C
	DW $0001, SL_C_SPW_DiagonalRight_0C : DB $0C, $0C
	DW $0001, SL_C_SP_DiagonalRight_1NA : DB $10, $10
	DW $0001, SL_C_SP_DiagonalRight_1CA : DB $10, $10
	DW $0001, SL_C_SPW_DiagonalRight_1N : DB $12, $12
	DW $0001, SL_C_SPW_DiagonalRight_1C : DB $12, $12
	DW $0001, SL_C_SPW_DiagonalRight_2N : DB $14, $14
	DW $0001, SL_C_SPW_DiagonalRight_2C : DB $14, $14
	DW $0001, SL_C_SP_DiagonalRight_NB : DB $14, $14
	DW $0001, SL_C_SP_DiagonalRight_CB : DB $14, $14
	DW $0001, SL_C_SPW_DiagonalRight_2N : DB $14, $14
	DW $0001, SL_C_SPW_DiagonalRight_2C : DB $14, $14
...
Charged_SpazerPlasmaWave_Horizontal_Loop:
	DW $0001, S_C_P_Horizontal_NA : DB $18, $0C
	DW $0001, S_C_P_Horizontal_CA : DB $18, $0C
	DW $0001, SL_C_SPW_Horizontal_0N : DB $18, $0C
	DW $0001, SL_C_SPW_Horizontal_0C : DB $18, $0C
	DW $0001, SL_C_SP_Horizontal_1NA : DB $18, $10
	DW $0001, SL_C_SP_Horizontal_1CA : DB $18, $10
	DW $0001, SL_C_SPW_Horizontal_1N : DB $18, $12
	DW $0001, SL_C_SPW_Horizontal_1C : DB $18, $12
	DW $0001, SL_C_SPW_Horizontal_2N : DB $18, $14
	DW $0001, SL_C_SPW_Horizontal_2C : DB $18, $14
	DW $0001, SL_C_SP_Horizontal_NB : DB $18, $14
	DW $0001, SL_C_SP_Horizontal_CB : DB $18, $14
	DW $0001, SL_C_SPW_Horizontal_2N : DB $18, $14
	DW $0001, SL_C_SPW_Horizontal_2C : DB $18, $14
...
Charged_SpazerPlasmaWave_DiagonalLeft_Loop:
	DW $0001, S_C_P_DiagonalLeft_NA : DB $0C, $0C
	DW $0001, S_C_P_DiagonalLeft_CA : DB $0C, $0C
	DW $0001, SL_C_SPW_DiagonalLeft_0N : DB $0C, $0C
	DW $0001, SL_C_SPW_DiagonalLeft_0C : DB $0C, $0C
	DW $0001, SL_C_SP_DiagonalLeft_1NA : DB $10, $10
	DW $0001, SL_C_SP_DiagonalLeft_1CA : DB $10, $10
	DW $0001, SL_C_SPW_DiagonalLeft_1N : DB $12, $12
	DW $0001, SL_C_SPW_DiagonalLeft_1C : DB $12, $12
	DW $0001, SL_C_SPW_DiagonalLeft_2N : DB $14, $14
	DW $0001, SL_C_SPW_DiagonalLeft_2C : DB $14, $14
	DW $0001, SL_C_SP_DiagonalLeft_NB : DB $14, $14
	DW $0001, SL_C_SP_DiagonalLeft_CB : DB $14, $14
	DW $0001, SL_C_SPW_DiagonalLeft_2N : DB $14, $14
	DW $0001, SL_C_SPW_DiagonalLeft_2C : DB $14, $14
...
SL_C_SPW_Vertical_0N:
	DW S_C_P_Vertical_NB : DB $00, $00
	DW S_C_P_Vertical_NB : DB $FC, $00
	DW S_C_P_Vertical_NB : DB $04, $00
	DW $0000
SL_C_SPW_Vertical_0C:
	DW S_C_P_Vertical_CB : DB $00, $00
	DW S_C_P_Vertical_CB : DB $FC, $00
	DW S_C_P_Vertical_CB : DB $04, $00
	DW $0000
SL_C_SPW_Vertical_1N:
	DW S_C_P_Vertical_NB : DB $00, $00
	DW S_C_P_Vertical_NB : DB $F3, $00
	DW S_C_P_Vertical_NB : DB $0D, $00
	DW $0000
SL_C_SPW_Vertical_1C:
	DW S_C_P_Vertical_CB : DB $00, $00
	DW S_C_P_Vertical_CB : DB $F3, $00
	DW S_C_P_Vertical_CB : DB $0D, $00
	DW $0000
SL_C_SPW_Vertical_2N:
	DW S_C_P_Vertical_NA : DB $00, $00
	DW S_C_P_Vertical_NA : DB $F1, $00
	DW S_C_P_Vertical_NA : DB $0F, $00
	DW $0000
SL_C_SPW_Vertical_2C:
	DW S_C_P_Vertical_CA : DB $00, $00
	DW S_C_P_Vertical_CA : DB $F1, $00
	DW S_C_P_Vertical_CA : DB $0F, $00
	DW $0000

SL_C_SPW_DiagonalRight_0N:
	DW S_C_P_DiagonalRight_NB : DB $00, $00
	DW S_C_P_DiagonalRight_NB : DB $FD, $FD
	DW S_C_P_DiagonalRight_NB : DB $03, $03
	DW $0000
SL_C_SPW_DiagonalRight_0C:
	DW S_C_P_DiagonalRight_CB : DB $00, $00
	DW S_C_P_DiagonalRight_CB : DB $FD, $FD
	DW S_C_P_DiagonalRight_CB : DB $03, $03
	DW $0000
SL_C_SPW_DiagonalRight_1N:
	DW S_C_P_DiagonalRight_NB : DB $00, $00
	DW S_C_P_DiagonalRight_NB : DB $F7, $F7
	DW S_C_P_DiagonalRight_NB : DB $09, $09
	DW $0000
SL_C_SPW_DiagonalRight_1C:
	DW S_C_P_DiagonalRight_CB : DB $00, $00
	DW S_C_P_DiagonalRight_CB : DB $F7, $F7
	DW S_C_P_DiagonalRight_CB : DB $09, $09
	DW $0000
SL_C_SPW_DiagonalRight_2N:
	DW S_C_P_DiagonalRight_NA : DB $00, $00
	DW S_C_P_DiagonalRight_NA : DB $F5, $F5
	DW S_C_P_DiagonalRight_NA : DB $0B, $0B
	DW $0000
SL_C_SPW_DiagonalRight_2C:
	DW S_C_P_DiagonalRight_CA : DB $00, $00
	DW S_C_P_DiagonalRight_CA : DB $F5, $F5
	DW S_C_P_DiagonalRight_CA : DB $0B, $0B
	DW $0000

SL_C_SPW_Horizontal_0N:
	DW S_C_P_Horizontal_NB : DB $00, $00
	DW S_C_P_Horizontal_NB : DB $00, $FC
	DW S_C_P_Horizontal_NB : DB $00, $04
	DW $0000
SL_C_SPW_Horizontal_0C:
	DW S_C_P_Horizontal_CB : DB $00, $00
	DW S_C_P_Horizontal_CB : DB $00, $FC
	DW S_C_P_Horizontal_CB : DB $00, $04
	DW $0000
SL_C_SPW_Horizontal_1N:
	DW S_C_P_Horizontal_NB : DB $00, $00
	DW S_C_P_Horizontal_NB : DB $00, $F3
	DW S_C_P_Horizontal_NB : DB $00, $0D
	DW $0000
SL_C_SPW_Horizontal_1C:
	DW S_C_P_Horizontal_CB : DB $00, $00
	DW S_C_P_Horizontal_CB : DB $00, $F3
	DW S_C_P_Horizontal_CB : DB $00, $0D
	DW $0000
SL_C_SPW_Horizontal_2N:
	DW S_C_P_Horizontal_NA : DB $00, $00
	DW S_C_P_Horizontal_NA : DB $00, $F1
	DW S_C_P_Horizontal_NA : DB $00, $0F
	DW $0000
SL_C_SPW_Horizontal_2C:
	DW S_C_P_Horizontal_CA : DB $00, $00
	DW S_C_P_Horizontal_CA : DB $00, $F1
	DW S_C_P_Horizontal_CA : DB $00, $0F
	DW $0000

SL_C_SPW_DiagonalLeft_0N:
	DW S_C_P_DiagonalLeft_NB : DB $00, $00
	DW S_C_P_DiagonalLeft_NB : DB $03, $FD
	DW S_C_P_DiagonalLeft_NB : DB $FD, $03
	DW $0000
SL_C_SPW_DiagonalLeft_0C:
	DW S_C_P_DiagonalLeft_CB : DB $00, $00
	DW S_C_P_DiagonalLeft_CB : DB $03, $FD
	DW S_C_P_DiagonalLeft_CB : DB $FD, $03
	DW $0000
SL_C_SPW_DiagonalLeft_1N:
	DW S_C_P_DiagonalLeft_NB : DB $00, $00
	DW S_C_P_DiagonalLeft_NB : DB $09, $F7
	DW S_C_P_DiagonalLeft_NB : DB $F7, $09
	DW $0000
SL_C_SPW_DiagonalLeft_1C:
	DW S_C_P_DiagonalLeft_CB : DB $00, $00
	DW S_C_P_DiagonalLeft_CB : DB $09, $F7
	DW S_C_P_DiagonalLeft_CB : DB $F7, $09
	DW $0000
SL_C_SPW_DiagonalLeft_2N:
	DW S_C_P_DiagonalLeft_NA : DB $00, $00
	DW S_C_P_DiagonalLeft_NA : DB $0B, $F5
	DW S_C_P_DiagonalLeft_NA : DB $F5, $0B
	DW $0000
SL_C_SPW_DiagonalLeft_2C:
	DW S_C_P_DiagonalLeft_CA : DB $00, $00
