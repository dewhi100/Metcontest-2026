...
Charged_PlasmaWave_Up:
	...
	DW $0001, SL_N_PW_Up_2 : DB $13, $10
	DW $0001, SL_C_PW_Up_2 : DB $13, $10
Charged_PlasmaWave_Up_Loop:
	DW $0001, SL_N_PW_Vertical_A : DB $14, $10
	DW $0001, SL_C_PW_Vertical_A : DB $14, $10
	DW $0001, SL_N_PW_Vertical_A : DB $14, $10
	DW $0001, SL_C_PW_Vertical_A0 : DB $13, $10
	DW $0001, SL_N_PW_Vertical_A0 : DB $13, $10
	DW $0001, SL_C_PW_Vertical_A1 : DB $10, $10
	DW $0001, SL_N_PW_Vertical_A2 : DB $0D, $10
	DW $0001, SL_C_PW_Vertical_A2 : DB $0D, $10
	DW $0001, SL_N_PW_Vertical_B : DB $0C, $10
	DW $0001, SL_C_PW_Vertical_B : DB $0C, $10
	DW $0001, SL_N_PW_Vertical_B : DB $0C, $10
	DW $0001, SL_C_PW_Vertical_B0 : DB $0D, $10
	DW $0001, SL_N_PW_Vertical_B0 : DB $0D, $10
	DW $0001, SL_C_PW_Vertical_B1 : DB $10, $10
	DW $0001, SL_N_PW_Vertical_B2 : DB $13, $10
	DW $0001, SL_C_PW_Vertical_B2 : DB $13, $10
...
Charged_PlasmaWave_UpRight:
	...
	DW $0001, SL_N_PW_UpRight_2 : DB $13, $13
	DW $0001, SL_C_PW_UpRight_2 : DB $13, $13
Charged_PlasmaWave_UpRight_Loop:
	DW $0001, SL_N_PW_DiagonalRight_A : DB $14, $14
	DW $0001, SL_C_PW_DiagonalRight_A : DB $14, $14
	DW $0001, SL_N_PW_DiagonalRight_A : DB $14, $14
	DW $0001, SL_C_PW_DiagonalRight_A0 : DB $13, $13
	DW $0001, SL_N_PW_DiagonalRight_A0 : DB $13, $13
	DW $0001, SL_C_PW_DiagonalRight_A1 : DB $10, $10
	DW $0001, SL_N_PW_DiagonalRight_A2 : DB $0D, $0D
	DW $0001, SL_C_PW_DiagonalRight_A2 : DB $0D, $0D
	DW $0001, SL_N_PW_DiagonalRight_B : DB $0C, $0C
	DW $0001, SL_C_PW_DiagonalRight_B : DB $0C, $0C
	DW $0001, SL_N_PW_DiagonalRight_B : DB $0C, $0C
	DW $0001, SL_C_PW_DiagonalRight_B0 : DB $0D, $0D
	DW $0001, SL_N_PW_DiagonalRight_B0 : DB $0D, $0D
	DW $0001, SL_C_PW_DiagonalRight_B1 : DB $10, $10
	DW $0001, SL_N_PW_DiagonalRight_B2 : DB $13, $13
	DW $0001, SL_C_PW_DiagonalRight_B2 : DB $13, $13
...
Charged_PlasmaWave_Right:
	...
	DW $0001, SL_N_PW_Right_2 : DB $10, $13
	DW $0001, SL_C_PW_Right_2 : DB $10, $13
Charged_PlasmaWave_Right_Loop:
	DW $0001, SL_N_PW_Horizontal_A : DB $10, $14
	DW $0001, SL_C_PW_Horizontal_A : DB $10, $14
	DW $0001, SL_N_PW_Horizontal_A : DB $10, $14
	DW $0001, SL_C_PW_Horizontal_A0 : DB $10, $13
	DW $0001, SL_N_PW_Horizontal_A0 : DB $10, $13
	DW $0001, SL_C_PW_Horizontal_A1 : DB $10, $10
	DW $0001, SL_N_PW_Horizontal_A2 : DB $10, $0D
	DW $0001, SL_C_PW_Horizontal_A2 : DB $10, $0D
	DW $0001, SL_N_PW_Horizontal_B : DB $10, $0C
	DW $0001, SL_C_PW_Horizontal_B : DB $10, $0C
	DW $0001, SL_N_PW_Horizontal_B : DB $10, $0C
	DW $0001, SL_C_PW_Horizontal_B0 : DB $10, $0D
	DW $0001, SL_N_PW_Horizontal_B0 : DB $10, $0D
	DW $0001, SL_C_PW_Horizontal_B1 : DB $10, $10
	DW $0001, SL_N_PW_Horizontal_B2 : DB $10, $13
	DW $0001, SL_C_PW_Horizontal_B2 : DB $10, $13
...
Charged_PlasmaWave_DownRight:
	...
	DW $0001, SL_N_PW_DownRight_2 : DB $13, $13
	DW $0001, SL_C_PW_DownRight_2 : DB $13, $13
Charged_PlasmaWave_DownRight_Loop:
	DW $0001, SL_N_PW_DiagonalLeft_A : DB $14, $14
	DW $0001, SL_C_PW_DiagonalLeft_A : DB $14, $14
	DW $0001, SL_N_PW_DiagonalLeft_A : DB $14, $14
	DW $0001, SL_C_PW_DiagonalLeft_A0 : DB $13, $13
	DW $0001, SL_N_PW_DiagonalLeft_A0 : DB $13, $13
	DW $0001, SL_C_PW_DiagonalLeft_A1 : DB $10, $10
	DW $0001, SL_N_PW_DiagonalLeft_A2 : DB $0D, $0D
	DW $0001, SL_C_PW_DiagonalLeft_A2 : DB $0D, $0D
	DW $0001, SL_N_PW_DiagonalLeft_B : DB $0C, $0C
	DW $0001, SL_C_PW_DiagonalLeft_B : DB $0C, $0C
	DW $0001, SL_N_PW_DiagonalLeft_B : DB $0C, $0C
	DW $0001, SL_C_PW_DiagonalLeft_B0 : DB $0D, $0D
	DW $0001, SL_N_PW_DiagonalLeft_B0 : DB $0D, $0D
	DW $0001, SL_C_PW_DiagonalLeft_B1 : DB $10, $10
	DW $0001, SL_N_PW_DiagonalLeft_B2 : DB $13, $13
	DW $0001, SL_C_PW_DiagonalLeft_B2 : DB $13, $13
...
Charged_PlasmaWave_Down:
	...
	DW $0001, SL_N_PW_Down_2 : DB $13, $10
	DW $0001, SL_C_PW_Down_2 : DB $13, $10
...
Charged_PlasmaWave_DownLeft:
	...
	DW $0001, SL_N_PW_DownLeft_2 : DB $13, $13
	DW $0001, SL_C_PW_DownLeft_2 : DB $13, $13
...
Charged_PlasmaWave_Left:
	...
	DW $0001, SL_N_PW_Left_2 : DB $10, $13
	DW $0001, SL_C_PW_Left_2 : DB $10, $13
...
Charged_PlasmaWave_UpLeft:
	...
	DW $0001, SL_N_PW_UpLeft_2 : DB $13, $13
	DW $0001, SL_C_PW_UpLeft_2 : DB $13, $13
...
S_C_P_Vertical_A0: DW $0004
	DW $0001 : DB $F0 : DW $6C3B
	DW $01FD : DB $F8 : DW $AC3B
	DW $01FB : DB $00 : DW $2C37
	DW $01FB : DB $08 : DW $EC37
S_C_P_Vertical_A1: DW $0004
	DW $0000 : DB $F0 : DW $2C37
	DW $01FE : DB $F8 : DW $6C3B
	DW $01FA : DB $00 : DW $AC3B
	DW $01F8 : DB $08 : DW $EC37
S_C_P_Vertical_A2: DW $0004
	DW $01FD : DB $F0 : DW $2C37
	DW $01FD : DB $F8 : DW $EC37
	DW $01FB : DB $00 : DW $6C3B
	DW $01F7 : DB $08 : DW $AC3B

S_C_P_Vertical_B0: DW $0004
	DW $01F7 : DB $F0 : DW $2C3B
	DW $01FB : DB $F8 : DW $EC3B
	DW $01FD : DB $00 : DW $2C37
	DW $01FD : DB $08 : DW $EC37
S_C_P_Vertical_B1: DW $0004
	DW $01F8 : DB $F0 : DW $2C37
	DW $01FA : DB $F8 : DW $2C3B
	DW $01FE : DB $00 : DW $EC3B
	DW $0000 : DB $08 : DW $EC37
S_C_P_Vertical_B2: DW $0004
	DW $01FB : DB $F0 : DW $2C37
	DW $01FB : DB $F8 : DW $EC37
	DW $01FD : DB $00 : DW $2C3B
	DW $0001 : DB $08 : DW $EC3B

S_C_P_DiagonalRight_A0: DW $0004
	DW $01F3 : DB $04 : DW $AC36
	DW $01F9 : DB $FE : DW $6C36
	DW $01FF : DB $F9 : DW $6C3A
	DW $0007 : DB $F7 : DW $AC3A
S_C_P_DiagonalRight_A1: DW $0004
	DW $01F2 : DB $02 : DW $AC36
	DW $01F8 : DB $FD : DW $6C3A
	DW $0000 : DB $FB : DW $AC3A
	DW $0006 : DB $F6 : DW $6C36
S_C_P_DiagonalRight_A2: DW $0004
	DW $01F1 : DB $01 : DW $6C3A
	DW $01F9 : DB $FF : DW $AC3A
	DW $01FF : DB $FA : DW $AC36
	DW $0005 : DB $F4 : DW $6C36

S_C_P_DiagonalRight_B0: DW $0004
	DW $01F4 : DB $05 : DW $AC36
	DW $01FA : DB $FF : DW $6C36
	DW $01FF : DB $F9 : DW $6C3B
	DW $0001 : DB $F1 : DW $AC3B
S_C_P_DiagonalRight_B1: DW $0004
	DW $01F6 : DB $06 : DW $AC36
	DW $01FB : DB $00 : DW $6C3B
	DW $01FD : DB $F8 : DW $AC3B
	DW $0002 : DB $F2 : DW $6C36
S_C_P_DiagonalRight_B2: DW $0004
	DW $01F7 : DB $07 : DW $6C3B
	DW $01F9 : DB $FF : DW $AC3B
	DW $01FE : DB $F9 : DW $6C36
	DW $0004 : DB $F3 : DW $AC36

S_C_P_Horizontal_A0: DW $0004
	DW $01F0 : DB $FB : DW $2C35
	DW $01F8 : DB $FB : DW $EC35
	DW $0000 : DB $FD : DW $2C3A
	DW $0008 : DB $01 : DW $EC3A
S_C_P_Horizontal_A1: DW $0004
	DW $01F0 : DB $F8 : DW $2C35
	DW $01F8 : DB $FA : DW $2C3A
	DW $0000 : DB $FE : DW $EC3A
	DW $0008 : DB $00 : DW $EC35
S_C_P_Horizontal_A2: DW $0004
	DW $01F0 : DB $F7 : DW $2C3A
	DW $01F8 : DB $FB : DW $EC3A
	DW $0000 : DB $FD : DW $2C35
	DW $0008 : DB $FD : DW $EC35

S_C_P_Horizontal_B0: DW $0004
	DW $01F0 : DB $FD : DW $2C35
	DW $01F8 : DB $FD : DW $EC35
	DW $0000 : DB $FB : DW $AC3A
	DW $0008 : DB $F7 : DW $6C3A
S_C_P_Horizontal_B1: DW $0004
	DW $01F0 : DB $00 : DW $2C35
	DW $01F8 : DB $FE : DW $AC3A
	DW $0000 : DB $FA : DW $6C3A
	DW $0008 : DB $F8 : DW $EC35
S_C_P_Horizontal_B2: DW $0004
	DW $01F0 : DB $01 : DW $AC3A
	DW $01F8 : DB $FD : DW $6C3A
	DW $0000 : DB $FB : DW $2C35
	DW $0008 : DB $FB : DW $EC35

S_C_P_DiagonalLeft_A0: DW $0004
	DW $01F4 : DB $F3 : DW $2C36
	DW $01FA : DB $F9 : DW $EC36
	DW $01FF : DB $FF : DW $EC3B
	DW $0001 : DB $07 : DW $2C3B
S_C_P_DiagonalLeft_A1: DW $0004
	DW $01F6 : DB $F2 : DW $2C36
	DW $01FB : DB $F8 : DW $EC3B
	DW $01FD : DB $00 : DW $2C3B
	DW $0002 : DB $06 : DW $EC36
S_C_P_DiagonalLeft_A2: DW $0004
	DW $01F7 : DB $F1 : DW $EC3B
	DW $01F9 : DB $F9 : DW $2C3B
	DW $01FE : DB $FF : DW $2C36
	DW $0004 : DB $05 : DW $EC36

S_C_P_DiagonalLeft_B0: DW $0004
	DW $01F3 : DB $F4 : DW $2C36
	DW $01F9 : DB $FA : DW $EC36
	DW $01FF : DB $FF : DW $EC3A
	DW $0007 : DB $01 : DW $2C3A
S_C_P_DiagonalLeft_B1: DW $0004
	DW $01F2 : DB $F6 : DW $2C36
	DW $01F8 : DB $FB : DW $EC3A
	DW $0000 : DB $FD : DW $2C3A
	DW $0006 : DB $02 : DW $EC36
S_C_P_DiagonalLeft_B2: DW $0004
	DW $01F1 : DB $F7 : DW $EC3A
