...
Charged_SpazerWave_Up_Loop:
	...
	DW $0001, SL_C_SW_Vertical_A : DB $10, $08
	DW $0001, SL_C_SW_Up_2N : DB $0D, $08
	DW $0001, SL_C_SW_Up_2C : DB $0C, $08
	DW $0001, SL_N_SW_Vertical : DB $0C, $08
	DW $0001, SL_C_SW_Vertical : DB $0C, $08
	DW $0001, SL_N_SW_Vertical : DB $0C, $08
	DW $0001, SL_C_SW_Down_2C : DB $0C, $08
	DW $0001, SL_C_SW_Down_2N : DB $0D, $08
	DW $0001, SL_C_SW_Vertical_B : DB $10, $08
...
Charged_SpazerWave_UpRight_Loop:
	...
	DW $0001, SL_C_SW_DiagonalRight_A : DB $0E, $0E
	DW $0001, SL_C_SW_UpRight_2N : DB $0D, $0D
	DW $0001, SL_C_SW_UpRight_2C : DB $0C, $0C
	DW $0001, SL_N_SW_DiagonalRight : DB $0C, $0C
	DW $0001, SL_C_SW_DiagonalRight : DB $0C, $0C
	DW $0001, SL_N_SW_DiagonalRight : DB $0C, $0C
	DW $0001, SL_C_SW_DownLeft_2C : DB $0C, $0C
	DW $0001, SL_C_SW_DownLeft_2N : DB $0D, $0D
	DW $0001, SL_C_SW_DiagonalRight_B : DB $0E, $0E
...
Charged_SpazerWave_Right_Loop:
	...
	DW $0001, SL_C_SW_Horizontal_A : DB $08, $10
	DW $0001, SL_C_SW_Right_2N : DB $08, $0D
	DW $0001, SL_C_SW_Right_2C : DB $08, $0C
	DW $0001, SL_N_SW_Horizontal : DB $08, $0C
	DW $0001, SL_C_SW_Horizontal : DB $08, $0C
	DW $0001, SL_N_SW_Horizontal : DB $08, $0C
	DW $0001, SL_C_SW_Left_2C : DB $08, $0C
	DW $0001, SL_C_SW_Left_2N : DB $08, $0D
	DW $0001, SL_C_SW_Horizontal_B : DB $08, $10
...
Charged_SpazerWave_DownRight_Loop:
	...
	DW $0001, SL_C_SW_DiagonalLeft_A : DB $0E, $0E
	DW $0001, SL_C_SW_DownRight_2N : DB $0D, $0D
	DW $0001, SL_C_SW_DownRight_2C : DB $0C, $0C
	DW $0001, SL_N_SW_DiagonalLeft : DB $0C, $0C
	DW $0001, SL_C_SW_DiagonalLeft : DB $0C, $0C
	DW $0001, SL_N_SW_DiagonalLeft : DB $0C, $0C
	DW $0001, SL_C_SW_UpLeft_2C : DB $0C, $0C
	DW $0001, SL_C_SW_UpLeft_2N : DB $0D, $0D
	DW $0001, SL_C_SW_DiagonalLeft_B : DB $0E, $0E
...
SL_C_SW_Vertical:
	DW S_C_S_Vertical : DB $00, $00
	DW S_C_S_Vertical : DB $F8, $00
	DW S_C_S_Vertical : DB $08, $00
	DW $0000
SL_C_SW_DiagonalRight:
	DW S_C_S_DiagonalRight : DB $00, $00
	DW S_C_S_DiagonalRight : DB $06, $06
	DW S_C_S_DiagonalRight : DB $FA, $FA
	DW $0000
SL_C_SW_Horizontal:
	DW S_C_S_Horizontal : DB $00, $00
	DW S_C_S_Horizontal : DB $00, $08
	DW S_C_S_Horizontal : DB $00, $F8
	DW $0000
SL_C_SW_DiagonalLeft:
	DW S_C_S_DiagonalLeft : DB $00, $00
	DW S_C_S_DiagonalLeft : DB $FA, $06
	DW S_C_S_DiagonalLeft : DB $06, $FA
	DW $0000

SL_C_SW_Vertical_A:
	DW S_C_S_Vertical : DB $00, $00
	DW S_C_S_DiagonalVerticalRight : DB $F4, $00
	DW S_C_S_DiagonalVerticalLeft : DB $0C, $00
	DW $0000
SL_C_SW_Vertical_B:
	DW S_C_S_Vertical : DB $00, $00
	DW S_C_S_DiagonalVerticalLeft : DB $F4, $00
	DW S_C_S_DiagonalVerticalRight : DB $0C, $00
	DW $0000
SL_C_SW_DiagonalRight_A:
	DW S_C_S_DiagonalRight : DB $00, $00
	DW S_C_S_DiagonalHorizontalRight : DB $F7, $F7
	DW S_C_S_DiagonalVerticalRight : DB $09, $09
	DW $0000
SL_C_SW_DiagonalRight_B:
	DW S_C_S_DiagonalRight : DB $00, $00
	DW S_C_S_DiagonalVerticalRight : DB $F7, $F7
	DW S_C_S_DiagonalHorizontalRight : DB $09, $09
	DW $0000
SL_C_SW_Horizontal_A:
	DW S_C_S_Horizontal : DB $00, $00
	DW S_C_S_DiagonalHorizontalLeft : DB $00, $F4
	DW S_C_S_DiagonalHorizontalRight : DB $00, $0C
	DW $0000
SL_C_SW_Horizontal_B:
	DW S_C_S_Horizontal : DB $00, $00
	DW S_C_S_DiagonalHorizontalRight : DB $00, $F4
	DW S_C_S_DiagonalHorizontalLeft : DB $00, $0C
	DW $0000
SL_C_SW_DiagonalLeft_A:
	DW S_C_S_DiagonalLeft : DB $00, $00
	DW S_C_S_DiagonalVerticalLeft : DB $09, $F7
	DW S_C_S_DiagonalHorizontalLeft : DB $F7, $09
	DW $0000
SL_C_SW_DiagonalLeft_B:
	DW S_C_S_DiagonalLeft : DB $00, $00
...
SL_C_SW_Up_2N:
	DW S_N_S_Vertical : DB $00, $00
	DW S_N_S_Vertical_DownLeft : DB $F6, $00
	DW S_N_S_Vertical_DownRight : DB $0A, $00
	DW $0000
SL_C_SW_Up_2C:
	DW S_C_S_Vertical : DB $00, $00
	DW S_C_S_Vertical_DownLeft : DB $F8, $00
	DW S_C_S_Vertical_DownRight : DB $08, $00
	DW $0000
SL_C_SW_UpRight_2N:
	DW S_N_S_DiagonalRight : DB $00, $00
	DW S_N_S_DiagonalRight_Down : DB $07, $07
	DW S_N_S_DiagonalRight_Left : DB $F9, $F9
	DW $0000
SL_C_SW_UpRight_2C:
	DW S_C_S_DiagonalRight : DB $00, $00
	DW S_C_S_DiagonalRight_Down : DB $06, $06
	DW S_C_S_DiagonalRight_Left : DB $FA, $FA
	DW $0000
SL_C_SW_Right_2N:
	DW S_N_S_Horizontal : DB $00, $00
	DW S_N_S_Horizontal_DownLeft : DB $00, $0A
	DW S_N_S_Horizontal_UpLeft : DB $00, $F6
	DW $0000
SL_C_SW_Right_2C:
	DW S_C_S_Horizontal : DB $00, $00
	DW S_C_S_Horizontal_DownLeft : DB $00, $08
	DW S_C_S_Horizontal_UpLeft : DB $00, $F8
	DW $0000
SL_C_SW_DownRight_2N:
	DW S_N_S_DiagonalLeft : DB $00, $00
	DW S_N_S_DiagonalLeft_Left : DB $F9, $07
	DW S_N_S_DiagonalLeft_Up : DB $07, $F9
	DW $0000
SL_C_SW_DownRight_2C:
	DW S_C_S_DiagonalLeft : DB $00, $00
	DW S_C_S_DiagonalLeft_Left : DB $FA, $06
	DW S_C_S_DiagonalLeft_Up : DB $06, $FA
	DW $0000
SL_C_SW_Down_2N:
	DW S_N_S_Vertical : DB $00, $00
	DW S_N_S_Vertical_UpLeft : DB $F6, $00
	DW S_N_S_Vertical_UpRight : DB $0A, $00
	DW $0000
SL_C_SW_Down_2C:
	DW S_C_S_Vertical : DB $00, $00
	DW S_C_S_Vertical_UpLeft : DB $F8, $00
	DW S_C_S_Vertical_UpRight : DB $08, $00
	DW $0000
SL_C_SW_DownLeft_2N:
	DW S_N_S_DiagonalRight : DB $00, $00
	DW S_N_S_DiagonalRight_Right : DB $07, $07
	DW S_N_S_DiagonalRight_Up : DB $F9, $F9
	DW $0000
SL_C_SW_DownLeft_2C:
	DW S_C_S_DiagonalRight : DB $00, $00
	DW S_C_S_DiagonalRight_Right : DB $06, $06
	DW S_C_S_DiagonalRight_Up : DB $FA, $FA
	DW $0000
SL_C_SW_Left_2N:
	DW S_N_S_Horizontal : DB $00, $00
	DW S_N_S_Horizontal_DownRight : DB $00, $0A
	DW S_N_S_Horizontal_UpRight : DB $00, $F6
	DW $0000
SL_C_SW_Left_2C:
	DW S_C_S_Horizontal : DB $00, $00
	DW S_C_S_Horizontal_DownRight : DB $00, $08
	DW S_C_S_Horizontal_UpRight : DB $00, $F8
	DW $0000
SL_C_SW_UpLeft_2N:
	DW S_N_S_DiagonalLeft : DB $00, $00
	DW S_N_S_DiagonalLeft_Down : DB $F9, $07
	DW S_N_S_DiagonalLeft_Right : DB $07, $F9
	DW $0000
SL_C_SW_UpLeft_2C:
	DW S_C_S_DiagonalLeft : DB $00, $00
	DW S_C_S_DiagonalLeft_Down : DB $FA, $06
	DW S_C_S_DiagonalLeft_Right : DB $06, $FA
	DW $0000
}
