...
SL_N_W_Horizontal_Up_2A:
	DW S_N_W_DiagonalRight_Right : DB $00, $F4
	DW $0000
SL_N_W_Horizontal_Up_3A:
	DW S_N_W_Horizontal_DownLeft : DB $00, $F0
	DW $0000
SL_N_W_Horizontal_Up:
	DW S_N_W_Horizontal : DB $00, $F0
	DW $0000
SL_N_W_Horizontal_Up_3B:
	DW S_N_W_Horizontal_DownRight : DB $00, $F0
	DW $0000
SL_N_W_Horizontal_Up_2B:
	DW S_N_W_DiagonalLeft_Left : DB $00, $F4
	DW $0000
...
SL_N_W_Vertical_Right_2A:
	DW S_N_W_DiagonalRight_Up : DB $0C, $00
	DW $0000
SL_N_W_Vertical_Right_3A:
	DW S_N_W_Vertical_DownLeft : DB $10, $00
	DW $0000
SL_N_W_Vertical_Right:
	DW S_N_W_Vertical : DB $10, $00
	DW $0000
SL_N_W_Vertical_Right_3B:
	DW S_N_W_Vertical_UpLeft : DB $10, $00
	DW $0000
SL_N_W_Vertical_Right_2B:
	DW S_N_W_DiagonalLeft_Down : DB $0C, $00
	DW $0000
...
SL_N_W_Horizontal_Down_2A:
	DW S_N_W_DiagonalLeft_Right : DB $00, $0C
	DW $0000
SL_N_W_Horizontal_Down_3A:
	DW S_N_W_Horizontal_UpLeft : DB $00, $10
	DW $0000
SL_N_W_Horizontal_Down:
	DW S_N_W_Horizontal : DB $00, $10
	DW $0000
SL_N_W_Horizontal_Down_3B:
	DW S_N_W_Horizontal_UpRight : DB $00, $10
	DW $0000
SL_N_W_Horizontal_Down_2B:
	DW S_N_W_DiagonalRight_Left : DB $00, $0C
	DW $0000
...
SL_N_W_Vertical_Left_2A:
	DW S_N_W_DiagonalLeft_Up : DB $F4, $00
	DW $0000
SL_N_W_Vertical_Left_3A:
	DW S_N_W_Vertical_DownRight : DB $F0, $00
	DW $0000
SL_N_W_Vertical_Left:
	DW S_N_W_Vertical : DB $F0, $00
	DW $0000
SL_N_W_Vertical_Left_3B:
	DW S_N_W_Vertical_UpRight : DB $F0, $00
	DW $0000
SL_N_W_Vertical_Left_2B:
	DW S_N_W_DiagonalRight_Down : DB $F4, $00
	DW $0000
