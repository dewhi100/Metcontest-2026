...
SL_C_W_DiagonalRight_3C:
	DW S_C_Projectile : DB $F5, $F5
	DW S_C_Projectile : DB $0B, $0B
	DW $0000
...
SL_C_W_DiagonalLeft_3C:
	DW S_C_Projectile : DB $0B, $F5
	DW S_C_Projectile : DB $F5, $0B
	DW $0000
