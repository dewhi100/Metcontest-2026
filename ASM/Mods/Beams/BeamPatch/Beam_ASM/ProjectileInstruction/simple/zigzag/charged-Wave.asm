...
SL_C_W_Vertical_1N:
	...
	DW $0000
SL_C_W_Vertical_1W:
	DW S_W_Projectile : DB $FC, $00
	DW S_W_Projectile : DB $04, $00
	DW $0000
SL_C_W_Vertical_2N:
...
SL_C_W_Vertical_3N:
	...
	DW $0000
SL_C_W_Vertical_3W:
	DW S_W_Projectile : DB $F4, $00
	DW S_W_Projectile : DB $0C, $00
	DW $0000
SL_C_W_Vertical_4N:
...
SL_C_W_DiagonalRight_1W:
	DW S_W_Projectile : DB $FD, $FD
	DW S_W_Projectile : DB $03, $03
	DW $0000
...
SL_C_W_DiagonalRight_3W:
	DW S_W_Projectile : DB $F7, $F7
	DW S_W_Projectile : DB $09, $09
	DW $0000
...
SL_C_W_Horizontal_1W:
	DW S_W_Projectile : DB $00, $FC
	DW S_W_Projectile : DB $00, $04
	DW $0000
...
SL_C_W_Horizontal_3W:
	DW S_W_Projectile : DB $00, $F4
	DW S_W_Projectile : DB $00, $0C
	DW $0000
...
SL_C_W_DiagonalLeft_1W:
	DW S_W_Projectile : DB $03, $FD
	DW S_W_Projectile : DB $FD, $03
	DW $0000
...
SL_C_W_DiagonalLeft_3W:
	DW S_W_Projectile : DB $09, $F7
	DW S_W_Projectile : DB $F7, $09
	DW $0000
