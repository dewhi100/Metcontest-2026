...
Normal_Wave_Vertical_Loop:
	...
	DW $0001, SL_N_W_Vertical_Left_2A : DB $10, $04
	DW $0001, SL_N_W_Vertical_Left_3 : DB $14, $04
	DW $0001, SL_N_W_Vertical_Left_3B : DB $10, $04
	DW $0001, SL_N_W_Vertical_Left_2 : DB $0C, $04
...
Normal_Wave_Vertical_Branch:
	...
	DW $0001, SL_N_W_Vertical_Right_2A : DB $10, $04
	DW $0001, SL_N_W_Vertical_Right_3 : DB $14, $04
	DW $0001, SL_N_W_Vertical_Right_3B : DB $10, $04
	DW $0001, SL_N_W_Vertical_Right_2 : DB $0C, $04
...
Normal_Wave_DiagonalRight_Loop:
	DW $0001, S_N_W_1 : DB $04, $04
	DW $0001, SL_N_W_DiagonalRight_UpLeft_1A : DB $06, $06
	DW $0001, SL_N_W_DiagonalRight_UpLeft_2 : DB $08, $08
	DW $0001, SL_N_W_DiagonalRight_UpLeft_2A : DB $0A, $0A
	DW $0001, SL_N_W_DiagonalRight_UpLeft_3 : DB $0C, $0C
	DW $0001, SL_N_W_DiagonalRight_UpLeft_3B : DB $0A, $0A
	DW $0001, SL_N_W_DiagonalRight_UpLeft_2 : DB $08, $08
	DW $0001, SL_N_W_DiagonalRight_UpLeft_2B : DB $06, $06
	DW $0001, S_N_W_1 : DB $04, $04
	DW $0001, SL_N_W_DiagonalRight_DownRight_1A : DB $06, $06
	DW $0001, SL_N_W_DiagonalRight_DownRight_2 : DB $08, $08
	DW $0001, SL_N_W_DiagonalRight_DownRight_2A : DB $0A, $0A
	DW $0001, SL_N_W_DiagonalRight_DownRight_3 : DB $0C, $0C
	DW $0001, SL_N_W_DiagonalRight_DownRight_3B : DB $0A, $0A
	DW $0001, SL_N_W_DiagonalRight_DownRight_2 : DB $08, $08
	DW $0001, SL_N_W_DiagonalRight_DownRight_2B : DB $06, $06
...
Normal_Wave_Horizontal_Loop:
	...
	DW $0001, SL_N_W_Horizontal_Up_2A : DB $04, $10
	DW $0001, SL_N_W_Horizontal_Up_3 : DB $04, $14
	DW $0001, SL_N_W_Horizontal_Up_3B : DB $04, $10
	DW $0001, SL_N_W_Horizontal_Up_2 : DB $04, $0C
	...
	DW $0001, SL_N_W_Horizontal_Down_2A : DB $04, $10
	DW $0001, SL_N_W_Horizontal_Down_3 : DB $04, $14
	DW $0001, SL_N_W_Horizontal_Down_3B : DB $04, $10
	DW $0001, SL_N_W_Horizontal_Down_2 : DB $04, $0C
...
Normal_Wave_DiagonalLeft_Loop:
	DW $0001, S_N_W_1 : DB $04, $04
	DW $0001, SL_N_W_DiagonalLeft_UpRight_1A : DB $06, $06
	DW $0001, SL_N_W_DiagonalLeft_UpRight_2 : DB $08, $08
	DW $0001, SL_N_W_DiagonalLeft_UpRight_2A : DB $0A, $0A
	DW $0001, SL_N_W_DiagonalLeft_UpRight_3 : DB $0C, $0C
	DW $0001, SL_N_W_DiagonalLeft_UpRight_3B : DB $0A, $0A
	DW $0001, SL_N_W_DiagonalLeft_UpRight_2 : DB $08, $08
	DW $0001, SL_N_W_DiagonalLeft_UpRight_2B : DB $06, $06
	DW $0001, S_N_W_1 : DB $04, $04
	DW $0001, SL_N_W_DiagonalLeft_DownLeft_1A : DB $06, $06
	DW $0001, SL_N_W_DiagonalLeft_DownLeft_2 : DB $08, $08
	DW $0001, SL_N_W_DiagonalLeft_DownLeft_2A : DB $0A, $0A
	DW $0001, SL_N_W_DiagonalLeft_DownLeft_3 : DB $0C, $0C
	DW $0001, SL_N_W_DiagonalLeft_DownLeft_3B : DB $0A, $0A
	DW $0001, SL_N_W_DiagonalLeft_DownLeft_2 : DB $08, $08
	DW $0001, SL_N_W_DiagonalLeft_DownLeft_2B : DB $06, $06
