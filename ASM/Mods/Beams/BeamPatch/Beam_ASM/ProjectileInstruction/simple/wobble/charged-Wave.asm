...
Charged_Wave_Vertical_Loop:
	...
	DW $0001, SL_C_W_Vertical_Left_1W : DB $0C, $08
...
Charged_Wave_Vertical_Branch:
	...
	DW $0001, SL_C_W_Vertical_Right_1W : DB $0C, $08
...
Charged_Wave_Ice_DownLeft:
	...
	DW $0001, SL_C_W_DiagonalRight_UpLeft_1W : DB $0A, $0A
	...
	DW $0001, SL_C_W_DiagonalRight_DownRight_1W : DB $0A, $0A
...
Charged_Wave_Ice_Left:
	...
	DW $0001, SL_C_W_Horizontal_Up_1W : DB $08, $0C
	...
	DW $0001, SL_C_W_Horizontal_Down_1W : DB $08, $0C
...
Charged_Wave_Ice_UpLeft:
	...
	DW $0001, SL_C_W_DiagonalLeft_UpRight_1W : DB $0A, $0A
	...
	DW $0001, SL_C_W_DiagonalLeft_DownLeft_1W : DB $0A, $0A
...
SL_C_W_Vertical_Left_1N:
	...
	DW $0000
SL_C_W_Vertical_Left_1W:
	DW S_W_Projectile : DB $FD, $00
	DW $0000
...
SL_C_W_Vertical_Right_1N:
	...
	DW $0000
SL_C_W_Vertical_Right_1W:
	DW S_W_Projectile : DB $03, $00
	DW $0000
...
SL_C_W_DiagonalRight_UpLeft_1N:
	...
	DW $0000
SL_C_W_DiagonalRight_UpLeft_1W:
	DW S_W_Projectile : DB $FE, $FE
	DW $0000
...
SL_C_W_DiagonalRight_DownRight_1N:
	...
	DW $0000
SL_C_W_DiagonalRight_DownRight_1W:
	DW S_W_Projectile : DB $02, $02
	DW $0000
...
SL_C_W_Horizontal_Up_1N:
	...
	DW $0000
SL_C_W_Horizontal_Up_1W:
	DW S_W_Projectile : DB $00, $FD
	DW $0000
...
SL_C_W_Horizontal_Down_1N:
	...
	DW $0000
SL_C_W_Horizontal_Down_1W:
	DW S_W_Projectile : DB $00, $03
	DW $0000
...
SL_C_W_DiagonalLeft_UpRight_1N:
	...
	DW $0000
SL_C_W_DiagonalLeft_UpRight_1W:
	DW S_W_Projectile : DB $02, $FE
	DW $0000
...
SL_C_W_DiagonalLeft_DownLeft_1N:
	...
	DW $0000
SL_C_W_DiagonalLeft_DownLeft_1W:
	DW S_W_Projectile : DB $FE, $02
	DW $0000
