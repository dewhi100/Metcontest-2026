...
Charged_Wave_Ice_DownLeft:
	...
	DW $0001, SL_C_W_DiagonalRight_3W : DB $11, $11
...
Charged_Wave_Ice_UpLeft:
	...
	DW $0001, SL_C_W_DiagonalLeft_3W : DB $11, $11
...
SL_C_W_DiagonalRight_1W:
	DW S_W_Projectile : DB $FB, $FB
	DW S_W_Projectile : DB $05, $05
	DW $0000
...
SL_C_W_Horizontal_3W:
	DW S_W_Projectile : DB $00, $F1
	DW S_W_Projectile : DB $00, $0F
	DW $0000
...
SL_C_W_DiagonalLeft_1W:
	DW S_W_Projectile : DB $05, $FB
	DW S_W_Projectile : DB $FB, $05
	DW $0000
