...
!TilemapIndexBase = (SparkBounceTilemaps-$92808D)/2	;Modified from the original, to be repointable. ensures that tilemap is stored on an odd (why?) byte
...
AFP_T20:		;for Samus Master Disassembly
Pose20GraphicIndexes:
	DB $01, $12, $01, $13
	DB $01, $1C, $00, $1E
AFP_T21:		;for Samus Master Disassembly
...
Fall:
	...
	print pc
	;Why no rts or jmp? Because the speedbooster routine does a PLA before the RTS. Sneaky, sneaky.
