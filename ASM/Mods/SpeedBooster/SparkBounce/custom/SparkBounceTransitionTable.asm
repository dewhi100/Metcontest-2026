...
T20:
;DW $0800,$0080,$00CB	;vertical spark facing right
DW $0010,$0000,$00CD ;diagonal spark facing right
DW $0100,$0000,$00C9 ;right spark
;DW $0000,$0000,$0020	;stay on wall
DW $FFFF

T21:
;DW $0800,$0080,$00CC	;up - vertical shinespark facing left
DW $0010,$0000,$00CE		;aim up - diagonal spark left
DW $0200,$0000,$00CA		;left -  left spark
;DW $0000,$0000,$0021		;stay on wall if holding jump
DW $FFFF
