...
;added respin transitions as well.
...
; ; New code
; org !free90	;!bank_90_free_space_start
; handle_spinjump:
; {
	...
	; !spacejump = #$0200
	; !spinboost = #$0100
	; LDA $09A2 : BIT !spacejump : BNE +
	; BIT !spinboost : BEQ ++
	; LDA !JumpCounter ;from the limited spacejump patch
	; CMP #$0002 : BMI +
	; ++
	; LDA $0A23 : AND #$00FF ; Previous movement type
...
T69:
T6B:
;DW !jump, !none, $0019	;respin. PJ modified the version from varia randomizer which itself modified Kejardon's respin
DW $0000,$0900,$0069
DW $0000,$0500,$006B
DW $0000,$0190,$0069
DW $0000,$01A0,$006B
...
T2D:
;dw !jump, !down, $002D ; PJ RESPIN (presumably this is where pj differs from repins of the past)
;dw !jump, !none, $0019	;respin
DW $0400,$0000,$0037
DW $0000,$0900,$006D
DW $0000,$0500,$006F
